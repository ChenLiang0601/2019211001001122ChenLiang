			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.ChenLiang.model.Order o=(com.ChenLiang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.ChenLiang.dao.UserDao userDao=new com.ChenLiang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.ChenLiang.model.Payment.findByPaymentId(con,n);
							 %>
